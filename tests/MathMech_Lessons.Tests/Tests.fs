        ...
        testList
            ...
            [ testCase "1 test for concatenation ML"
              <| fun _ ->
                  ...
                  Expect.equal actualResult (Cons(1, Cons(5, (Cons(2, Cons(9, Empty)))))) "The result should be (Cons(1, Cons(5, (Cons(2, Cons(9, Empty))))))"
              ...
              <| fun _ ->
                  ...
                  Expect.equal actualResult (Cons(1, Cons(2, Cons(3, Empty)))) "The result should be Cons(1, Cons(2, Cons(3, Empty)))"
              ...
              <| fun _ ->
                  ...
                  Expect.equal actualResult (Cons("a", Cons("ab", Cons("abc", Empty)))) "The result should be (Cons('a', Cons('ab', Cons('abc', Empty))))"
              ...
              <| fun _ ->
                  ...
                  Expect.equal actualResult (Cons(-10, Cons(1, Cons(5, Empty)))) "The result should be Cons(-10, Cons(1, Cons(5, Empty)))"
