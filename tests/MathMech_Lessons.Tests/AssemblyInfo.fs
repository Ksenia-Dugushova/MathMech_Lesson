...
[<assembly: AssemblyTitleAttribute("MathMech_Lessons.Tests")>]
[<assembly: AssemblyProductAttribute("MathMech_Lessons")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MathMech_Lessons.Tests"
    let [<Literal>] AssemblyProduct = "MathMech_Lessons"
